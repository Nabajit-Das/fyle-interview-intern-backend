...
from core.apis.assignments import student_assignments_resources, teacher_assignments_resources, principal_assignments, principal_assignments_grade
...
app.register_blueprint(principal_assignments, url_prefix='/principal')
app.register_blueprint(principal_assignments_grade,url_prefix='/principal')
